...
<script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/thickbox-code/thickbox-compressed.js"></script>

<style type="text/css" media="all">@import "<?php bloginfo('template_directory'); ?>/thickbox-code/thickbox.css";</style>
